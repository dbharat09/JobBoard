...
export default function EditHeadline({ navigation}){
    ...
    return(
        ...
        <Text style={styles.heading}>Edit Headline</Text>

        <View style={styles.inputWrapper}>
        <Text style={styles.inputheading}>Headline</Text>
        <TextInput
        style={styles.input}
        onChangeText={(text)=>setData({...data, headline: text})}
